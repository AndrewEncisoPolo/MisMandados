...
@section('empresa_content')
    ...
    <div class="container pb-4" style="margin-top:56px;">
        <div class="row pt-4">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pb-4">
                <h1>Mis Productos <button class="btn btn-outline-primary float-right mt-2" data-toggle="modal" data-target="#modal-agregar-producto">Agregar Producto</button></h1>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {get_productos();});
        ...
        $("select.filtros" ).change(function() {
            ...
            $.ajax({
                ...
                method:"POST",
                data:{IDMarca:idmarca,IDCategoria:idcategoria,IDUnidadMedidad:idunidad_medidad,_token:"{{csrf_token()}}"},
            ...
            form.addEventListener('submit', function(event) {
                ...
                if (form.checkValidity() === false) {
                    ...
                    if(crear==1){
                        ...
                        method:"POST",
                        data:{_token:"{{csrf_token()}}",IDProducto:id_producto,ValorProducto:id_valor_producto},
                        success:function(result)
                            {
                                if(result==1){
                                    $("#id_nombre").val("");
