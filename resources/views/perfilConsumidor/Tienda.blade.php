                            ...
                            <div class="card shadow-sm card-body py-2 px-0">
                                <div class="row">
                                    ...
                                    <div class="col-xsm-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center form-group">
                                        <div class="w-100 mx-auto" style="background:url({{$info_empresa->Archivo}});background-size: cover;background-position: center;height: 8rem;width: 14rem;min-width: 14rem;"></div>
                                    </div>
