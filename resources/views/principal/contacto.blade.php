        ...
        <div class="row" style="padding-top:1rem;">
            ...
            <div class="col-lg-12 form-group">
                <div class="container" style="margin-bottom:1.25rem;">   
                    <a>Mis Mandados es una empresa dedicada a solucionar y facilitar las entregas de productos y/o servicios que el consumidor final requiere de acuerdo a su necesidad.
                    Somos la empresa líder en conectar al comercio local
                    y los clientes finales de forma digital.</a>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="form-group text-center">                
                    <img src="../resources/img/MAN.png" style="width: 30%;">
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row" style="padding-top:1.25rem;padding-bottom:1.5rem;">
                <div class="col-lg-12 form-group">                
                    <h1>Contacto</h1>
                </div>
                <div class="col-lg-4 form-group">
                    <label for="id_nombre_contacto">Nombre</label>
                    <input class="form-control" type="text" name="" id="id_nombre_contacto">
                </div>
                <div class="col-lg-4 form-group">
                    <label for="id_Email_contacto">Correo Electrónico</label>
                ...
                <div class="col-lg-12 form-group">
                    <label for="id_mensaje_contacto">Mensaje</label>
                    <textarea class="form-control" type="text" name="" id="id_mensaje_contacto"></textarea>
                </div>
                <div class="col-lg-12 form-group text-center">
                    <button class="btn btn-danger" type="submit" style="width:30%;">Enviar</button>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row" style="padding-top:1.25rem;">
                ...
                <div class="col-xsm-12 col-xs-12 col-sm-12 col-md-6 col-lg-3 form-group text-center">
                    <a href="https://api.whatsapp.com/send?phone=573155000014&amp;text=Hola" style="width:100%;height:100%;">
                        <img src="../resources/img/whatsapp.png" style="width: 30%;">
                    </a><br>
                ...
                <div class="col-xsm-12 col-xs-12 col-sm-12 col-md-6 col-lg-3 form-group text-center">
                    ...
                    <img src="../resources/img/instagram.png" style="width: 30%;">
                    </a><br>
                ...
                <div class="col-xsm-12 col-xs-12 col-sm-12 col-md-6 col-lg-3 form-group text-center">
                    ...
                    <img src="../resources/img/facebook.png" style="width: 30%;">
                    </a><br>
                ...
                <div class="col-xsm-12 col-xs-12 col-sm-12 col-md-6 col-lg-3 form-group text-center">
                    ...
                    <img src="../resources/img/twitter.png" style="width: 30%;">
                    </a><br>
