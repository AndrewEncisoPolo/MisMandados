...
<div class="container" style="margin-top:56px;padding-bottom:1.25rem;">
    <div class="row" style="padding-top:1rem;">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-bottom: 2rem;">
            <h1>Barrio <button class="btn btn-outline-danger float-right" data-toggle="modal" data-target="#modal-crear-barrio" style="margin-top: 10px;">Crear Barrio</button></h1>
        </div>
